...
?>
<title>Alumni List | Alumni Aravali College of Engineering & Management</title>
<style>
#portfolio .img-fluid{
    width: calc(100%);
    height: 30vh;
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="input-group mb-3">
		                      ...
		                      <input type="text" class="form-control" id="filter" placeholder="Filter Name, Course ,Batch ,Company, etc..." aria-label="Filter" aria-describedby="filter-field">
		                    </div>
		                </div>
		                <div class="col-md-4">
